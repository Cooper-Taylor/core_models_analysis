...
| [`figures/`](figures/) | six figures — three flow charts of the method, three of the results — plus `fig_flowchart_values.tsv` |

*Superseded: this folder previously held six numbered files (`01_data.md` …
`06_reproduce.md`). They were merged into the single document above on
2026-08-12 so the facts live in one place; git history has them.*
